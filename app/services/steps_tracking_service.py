...
class StepsTrackingService:
    ...
    async def save_steps(
        ...
        try:
            ...
            logger.error(f"Error saving steps for user {user_id}: {e}")
            raise
    ...
    async def get_steps_for_date(
        ...
        try:
            ...
            logger.error(f"Error getting steps for user {user_id} on {steps_date}: {e}")
            return None
    ...
    async def get_steps_history(
        ...
        try:
            ...
            logger.error(f"Error getting steps history for user {user_id}: {e}")
            return []
    ...
    async def get_average_steps(
        ...
        try:
            ...
            logger.error(f"Error calculating average steps for user {user_id}: {e}")
            return 0
    ...
    async def calculate_bonus_calories(
        ...
        try:
            ...
            logger.error(f"Error calculating bonus calories for user {user_id}: {e}")
            return 0
