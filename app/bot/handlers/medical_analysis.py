    ...
    try:
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                logger.error("Error updating medical restrictions after analysis: {}", repr(e))
        ...
        logger.error("Error handling file upload with OCR: {}", repr(e), exc_info=True)
        await status_message.edit_text(
...
async def handle_text_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    try:
        ...
        logger.error("Error analyzing lab results: {}", repr(e), exc_info=True)
        await status_message.edit_text(
